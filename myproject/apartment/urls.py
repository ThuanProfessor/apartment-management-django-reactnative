...
router.register('survey-questions', views.SurveyQuestionViewSet, basename='survey-question')
router.register('survey-choices', views.SurveyChoiceViewSet, basename='survey-choice')
router.register('survey-results', views.SurveyResultViewSet, basename='survey-result')
router.register('survey-feedbacks', views.SurveyFeedbackViewSet, basename='survey-feedback')


# Nested: survey → results
router.register(r'surveys/(?P<survey_id>\d+)/results', views.SurveyResultViewSet, basename='survey-results')
